...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for VINU-MD bot",
    category: "download",
    ...
    try {
        ...
        const response = await axios.get(`https://tharusha-mdsession-1.onrender.com/pair/pair?phone=${encodeURIComponent(phoneNumber)}`);
        ...
        const doneMessage = "> *VINU-MD PAIRING COMPLETED*";
